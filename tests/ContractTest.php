...
it('declares operations for every BAPI endpoint the SDK calls', function (): void {
    ...
    $expected = [
        ...
        ['GET', '/v1/enterprise-connections/{enterprise_connection_id}'],
        ['PATCH', '/v1/enterprise-connections/{enterprise_connection_id}'],
        ['DELETE', '/v1/enterprise-connections/{enterprise_connection_id}'],
        ['POST', '/v1/enterprise-connections/{enterprise_connection_id}/test'],
        ['GET', '/v1/enterprise-accounts'],
        ['GET', '/v1/enterprise-accounts/{enterprise_account_id}'],
        ['DELETE', '/v1/enterprise-accounts/{enterprise_account_id}'],
