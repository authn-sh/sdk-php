...
final class BlocklistIdentifiersManager extends Manager
{
    ...
    {
        $payload = $this->transport->send('GET', '/v1/blocklist-identifiers', [
    ...
    {
        return $this->transport->send('POST', '/v1/blocklist-identifiers', [
            'body' => $data,
        ]);
    }
    ...
    {
        $this->transport->send('DELETE', '/v1/blocklist-identifiers/' . rawurlencode($id));
    }
}
